    ...
    j.display = {
        childRow: function (a, b, d) {
            ...
            return function (b, d, e) {
                if (d) c("div.dtr-modals-content").empty().append(e()); else {
                    var f = function () {
                            g.remove();
                            c(k).off("keypress.dtr")
                        },
                        g = c('<div class="dtr-modals"/>').append(c('<div class="dtr-modals-display"/>').append(c('<div class="dtr-modals-content"/>').append(e())).append(c('<div class="dtr-modals-close">&times;</div>').click(function () {
                            f()
                        }))).append(c('<div class="dtr-modals-background"/>').click(function () {
                            f()
                        })).appendTo("body");
                ...
                a && a.header && c("div.dtr-modals-content").prepend("<h2>" + a.header(b) + "</h2>")
            }
        }
    };
    j.renderer = {
